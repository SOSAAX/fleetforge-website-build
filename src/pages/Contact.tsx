          ...
          <div className="container-custom">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-primary-foreground/80">
                Ready to get started? Reach out by phone, email, or fill out the
                form below. We typically respond within a few hours during
                business hours.
              </p>
            </div>
          </div>
              ...
              <div className="lg:col-span-2">
                ...
                <div className="mt-6 flex items-start gap-3 text-muted-foreground">
                  ...
                  <p className="text-sm">
                    ...
                    hours. For urgent needs, please call us directly.
                  </p>
                </div>
              </div>
            </div>
